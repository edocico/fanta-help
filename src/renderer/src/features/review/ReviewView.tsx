      ...
      <div className="flex min-h-0 flex-1">
        <section className="flex min-w-0 flex-1 flex-col">
          <div className="flex flex-wrap items-center gap-2 border-b border-line px-4 py-2">
            <select
              className="rounded-md border border-line bg-surface-panel px-2 py-1 text-base"
              value={team}
              onChange={(e) =>
          ...
          {refusal !== null && (
            <p className="border-b border-line px-4 py-1.5 text-base text-blocking">{refusal}</p>
          )}

          <div className="min-h-0 flex-1 overflow-auto">
            {lines.length === 0 ? (
              <p className="px-4 py-4 text-base text-fg-muted">
          ...
          <div className="border-t border-line px-4 py-2">
            ...
            <div className="flex items-center gap-3">
              {asking && (
                ...
                <button
                  className="rounded-md border border-line px-3 py-1 text-base text-fg-muted hover:text-fg"
              ...
              <button
                className="mx-auto rounded-md border border-line bg-surface-raised px-4 py-1.5 text-base"
